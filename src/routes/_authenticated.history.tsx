...
type H = { id: string; video_id: string; title: string | null; channel: string | null; thumbnail: string | null; mode: string; watched_at: string; watch_seconds: number };
          ...
          items.map((it) => {
            ...
            return (
              <Link
                ...
                search={{ title: it.title || "", channel: it.channel || "", duration: 0, thumbnail: it.thumbnail || "" }}
